      ...
      {loading ? (
        ...
        <Fragment>
          <div className="mt-[69px] md:mt-10">
            <div className="text-2xl  flex justify-center md:text-4xl ">
              Products
            </div>
            ...
            <div className="flex md:mt-5">
              <div className="md:mx-5   md:w-[300px]">
              ...
              <div className="flex overflow-scroll scrollbar-hide  space-x-5 md:flex-wrap md:justify-center md:space-x-5">
                {product &&
                  product.map((product) => (
